...
buildsite: setwd ## create a website for the package
	...
	cp -rf docs/* ~/Documents/Pro_Website/Techtonique.github.io/nnetsauce_r/
...
clean: ## remove all build, and artifacts
	...
	rm -f src/*.so
	rm -f vignettes/*.html
	rm -rf /Library/Frameworks/R.framework/Versions/4.3-x86_64/Resources/library/nnetsauce
